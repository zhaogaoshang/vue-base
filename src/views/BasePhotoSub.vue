<template>
  <div class="base-photo">
    <el-card class="box-card">
      ...
      <div class="photo-box">
        <div class="item-image" :class="isEdit? 'active-an' : ''" v-for="(item, index) in 50" :key="index" @click="handleGoNextOrNavigater(index)" :style="'background-image: url(' + 'https://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png' + ');'">
          <!-- 没有编辑状态下的 -->
